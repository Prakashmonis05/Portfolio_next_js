      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-600 dark:text-zinc-300 text-base leading-relaxed">
            ...
            <div className="space-y-4 pt-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <strong className="block text-sm font-bold text-black dark:text-white">
                    Email
                  </strong>
          ...
          <div className="p-8 rounded-2xl bg-gray-50 dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 shadow-md">
