  ...
  return (
    <section className="py-16 px-6 sm:px-12 bg-white dark:bg-zinc-950">
      <div className="max-w-4xl mx-auto">
        ...
        {/* Content */}
        <div className="space-y-6 text-base sm:text-lg text-gray-600 dark:text-zinc-300 leading-relaxed">
          <p>
            Hi, I’m <strong className="text-[#ff0000] font-semibold">Prakash</strong> — a full-stack developer focused on building{" "}
            <strong className="text-black dark:text-white">fast</strong>,{" "}
            <strong className="text-black dark:text-white">scalable</strong>, and{" "}
            <strong className="text-black dark:text-white">real-world</strong> web applications.
            I enjoy solving problems and turning ideas into clean, production-ready code.
          </p>

          <p>
            I work with <strong className="text-black dark:text-white">Python</strong>,{" "}
            <strong className="text-black dark:text-white">Flask</strong>,{" "}
            <strong className="text-black dark:text-white">PHP</strong>, and modern backend patterns.
            My priority is simple: write code that is <strong className="text-black dark:text-white">maintainable</strong>,{" "}
            <strong className="text-black dark:text-white">efficient</strong>, and easy to scale.
          </p>
          ...
          <p>
            ...
            <strong className="text-black dark:text-white">MySQL</strong>,{" "}
            <strong className="text-black dark:text-white">SQLite</strong>,{" "}
            <strong className="text-black dark:text-white">PostgreSQL</strong>, and{" "}
            <strong className="text-black dark:text-white">MongoDB</strong>.
          ...
          {/* Highlight Box */}
          <div className="mt-10 p-6 sm:p-8 bg-gray-50 dark:bg-zinc-900 border-l-4 border-[#ff0000] rounded-r-2xl shadow-sm">
            <h3 className="text-xl font-bold text-black dark:text-white mb-2">
              What I Bring
            </h3>
            <p className="text-gray-700 dark:text-zinc-300 font-medium text-base">
